...
namespace WarShips
{
    internal class Program
    {
            ...
            while (counter < commands.Length)
            {
                ...
                if (counter % 2 == 0)
                {
                    if (IsInRange(coordinates, fieldSize))
                    {
                        ...
                        {
                            int[] after = Boom(matrix, coordinates, ref playerOneShips, ref playerTwoShips, fieldSize);
                        }
        ...
        public static int[] Boom(char[,] matrix, int[] coordinates, ref int st,ref int nd, int max)
        {
